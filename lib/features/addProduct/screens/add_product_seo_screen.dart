...
class AddProductSeoScreenState extends State<AddProductSeoScreen> {
  ...
  void initState() {
    ...
    if(_update) {
      tagList = widget.product?.tags?.map((t) => t.tag ?? '').where((t) => t.isNotEmpty).toList() ?? [];
                                                      ...
                                                      child: DottedBorder(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                            ...
                                                            Text(getTranslated('upload_file', context)!, style: robotoRegular.copyWith(color: Theme.of(context).primaryColor.withOpacity(0.7),))
                                                          ...
                                                          return InkWell(
                                                            ...
                                                            child: DottedBorder(
                                                              ...
                                                              child: Container(
                                                                width: double.infinity,
                                                                decoration: BoxDecoration(
                                                                  color: addProductImageController.selectedMetaImageFile != null ? Colors.black.withOpacity(0.5) : null,
                                                                  borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                                                                ),
                                                          ...
                                                          child: Stack(children: [
                                                            ...
                                                            Positioned(bottom: 0, right: 0, top: 0, left: 0,
                                                                child: Align(alignment: Alignment.center,
                                                                    child: Icon(Icons.camera_alt, color: Colors.black.withOpacity(0.5), size: 40))),
                                                      ...
                                                      Positioned(top: 5, right : 5,
                                                        child: InkWell(
                                                          ...
                                                          child: Container(decoration: BoxDecoration(
                                                              color: Colors.white,
                                                              boxShadow: [BoxShadow(color: Theme.of(context).hintColor.withOpacity(0.25), blurRadius: 1,spreadRadius: 1,offset: const Offset(0,0))],
                                                              borderRadius: const BorderRadius.all(Radius.circular(Dimensions.paddingSizeDefault))),
                                                              child: const Padding(
                                                                padding: EdgeInsets.all(4.0),
                                                                child: Icon(Icons.delete_forever_rounded,color: Colors.red,size: 25,),)),
                                ...
                                builder: (context, addProductImageController, _) {
                                  ...
                                  void submitForm() async {
                                    ...
                                    if ((!_update && addProductImageController.selectedLogoFile == null) || (_update && (addProductImageController.selectedLogoFile == null  && (widget.product?.thumbnailFullUrl?.path == null || widget.product?.thumbnailFullUrl?.path == ''))) ) {
                                      ...
                                      final tempRoute = (bool isRoute, String name, String type, String? colorCode) {
                                        route(isRoute, name, type, colorCode);
                                      };
                                      ...
                                      if(_update){
                                        ...
                                        if(addProductImageController.selectedLogoFile != null){
                                          await addProductImageController.addProductImage(context,addProductImageController.thumbnailImageModel, tempRoute, update: _update);

                                        }

                                        if(addProductImageController.selectedMetaImageFile != null){
                                          await addProductImageController.addProductImage(Get.context!, addProductImageController.metaImageModel, tempRoute, update: _update);
                                        ...
                                        if(addProductImageController.withoutColor.isNotEmpty) {
                                          for(int i =0; i<addProductImageController.withoutColor.length; i++) {
                                            if(addProductImageController.withoutColor[i].image != null){
                                              await addProductImageController.addProductImage(Get.context!, addProductImageController.withoutColor[i], tempRoute, index: i, update: _update);
                                            }
                                          }
                                        }
                                      }
                                        ...
                                        if(addProductImageController.selectedLogoFile != null){
                                          await addProductImageController.addProductImage(context, addProductImageController.thumbnailImageModel, tempRoute);
                                        }

                                        if(addProductImageController.selectedMetaImageFile != null) {
                                          await addProductImageController.addProductImage(Get.context!, addProductImageController.metaImageModel,tempRoute);
                                        }


                                        if(addProductImageController.imagesWithColor.isNotEmpty) {
                                          for(int i =0; i<addProductImageController.imagesWithColor.length; i++) {
                                            await addProductImageController.addProductImage(Get.context!, addProductImageController.imagesWithColor[i], tempRoute);
                                          }
                                        }
                                        ...
                                        if(addProductImageController.withoutColor.isNotEmpty){
                                          for(int i =0; i<addProductImageController.withoutColor.length; i++) {
                                            await addProductImageController.addProductImage(Get.context!, addProductImageController.withoutColor[i], tempRoute);
                                          }
                                        }
